...
function mafia(key) {
		...
		var div = "<div id='gangs' style='margin-top: 14px;'> <span class='gangs' id='gang'>  <strong>👑 Mafia: </strong>" +key+ "</span></div>";
...
function gang(key) {
		...
		var div = "<div id='gangs' style='margin-top: 14px;'> <span class='gangs' id='gang'>  <strong>⚔️ Mafia: </strong>" +key+ "</span></div>";
		$(".playerStats").append(div);
